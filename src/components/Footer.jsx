...
const Footer = () => {
  return (
    <footer className="bg-secondary text-light w-full">
      <div className="max-w-6xl mx-auto px-4 pt-10 pb-4">
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/3 lg:w-1/4 mb-8 pr-0 md:pr-16">
            ...
            <p className="text-light/90 leading-relaxed">Votre solution simple et efficace pour la gestion de réservation de voitures.</p>
          </div>
          
          <div className="flex-1 flex flex-wrap justify-between">
            <div className="w-1/2 md:w-auto mb-8 mr-0 md:mr-10">
              <h4 className="text-lg font-semibold mb-4 relative after:content-[''] after:absolute after:left-0 after:bottom-[-5px] after:w-8 after:h-0.5 after:bg-primary">
                Services
              </h4>
